...
const SLUG_ICON_MAP: Record<string, any> = {
  /* ابزارهای عمومی */
  translate: Languages,
...
export default function FavoriteTools({
  ...
  const getIcon = (
    ...
    /*
     * اول بر اساس slug بررسی می‌کنیم.
     * این باعث می‌شود حتی اگر اطلاعات قدیمی
     * localStorage آیکون اشتباه داشته باشند،
     * آیکون صحیح نمایش داده شود.
     */
    ...
    /*
     * اگر slug در نقشه نبود،
     * از toolIcon ذخیره‌شده استفاده می‌کنیم.
     */
...
function formatFavoriteTime(timestamp: number) {
  /*
   * اگر addedAt وجود نداشته باشد،
   * به جای Invalid Date یک متن مناسب نمایش می‌دهیم.
   */
